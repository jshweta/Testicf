...
if(!class_exists('SIB_Forms')) {
    class SIB_Forms
    {
        ...
        public static function addForm($formData)
        {
            ...
            $query .= '(title,html,css,dependTheme,listID,templateID,isOpt,isDopt,redirectInEmail,redirectInForm,successMsg,errorMsg,existMsg,invalidMsg,attributes,date) ';
        ...
        '{$formData['successMsg']}','{$formData['errorMsg']}','{$formData['existMsg']}','{$formData['invalidMsg']}','{$formData['attributes']}','{$current_date}')";
            $wpdb->query($query);
        ...
        successMsg='{$formData['successMsg']}',errorMsg='{$formData['errorMsg']}',existMsg='{$formData['existMsg']}',invalidMsg='{$formData['invalidMsg']}',date='{$current_date}',attributes='{$formData['attributes']}' ";
