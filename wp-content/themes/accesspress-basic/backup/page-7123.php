                    ...
                    <div class="container">
                        ...
                        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                            <ul class="nav navbar-nav">
                                <li>
                                    <a href="/books/" style="color: grey;">Books</a>
                                </li>
                                <li>
...
<!-- Internal Resource Books Page Starts -->
                          <h2 class="books-head">BOOKS</h2><div class="rline-book"> <div class="rline"><hr></div> </div>
                               	 <ul>
                                        ...
                                        <?php
                                                ...
                                                $args = array(
                                                  ...
                                                  'cat' => 863, // add any other query parameter to this array
                                                  'paged' => $paged
                                                );
                                                query_posts($args);
...
<!-- Internal Resource Books Page Ends -->
