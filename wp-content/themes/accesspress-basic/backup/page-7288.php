<?php
/**
 * The template for displaying VIDEOS pages --> Seminar category.
 *
...
<!-- Internal Resource Video Page Starts -->
        <h2 class="videos-head">VIDEOS</h2><div class="rline-videos"> <div class="rline"><hr></div> </div>
                    	 ...
                    	 <?php query_posts('cat=1203&showposts=1'); while (have_posts()) : the_post(); ?>
                           ...
                           <ul class="youtube-video-gallery" style="padding-top:50px;">
                                        <?php
                                                ...
                                                $args = array(
                                                  ...
                                                  'cat' => 1203, // add any other query parameter to this array
                                                  'paged' => $paged,
						  'offset' => 1
                                                );
                                                query_posts($args);
