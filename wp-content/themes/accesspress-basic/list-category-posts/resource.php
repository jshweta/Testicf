...
$lcp_display_output .= '<ul class="lcp_catlist_resource">';
...
foreach ($this->catlist->get_categories_posts() as $single){
  ...
  $lcp_display_output .= $this->get_post_title($single, 'h4', 'lcp_post_resource');
...
//  $lcp_display_output .= $this->get_thumbnail($single);
  ...
  $lcp_display_output .= $this->get_content($single, 'p', 'lcp_content_resource');
  ...
  $lcp_display_output .= $this->get_excerpt($single, 'div', 'lcp_excerpt_resource');
